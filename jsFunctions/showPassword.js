eyeId.addEventListener("click", function () {
  if (document.getElementById("passwordId").type == "password") {
...
eyeId2.addEventListener("click", function () {
  if (document.getElementById("passwordId2").type == "password") {
