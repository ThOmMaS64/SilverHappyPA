...
session_start();
    ...
    $errorMessages = [
        ...
        "not_registered" => "Nom d'utilisateur inexistant",
        ...
        "bad_registration" => "Vous n'avez pas l'autorisation d'accéder au backoffice.",
    ...
    <main>
        <div class="backgroundPlain">
            <div class="col-4 backgroundForm">
                <form class="row g-3 needs-validation" method="POST" action="http://localhost:8081/loginBack" novalidate>
                    <div class="row">
                        <div class="col-12">
