...
<html lang="en">
    ...
    <?php 
        ...
        if(isset($_SESSION['id'])){
            ...
            $dataJson = file_get_contents("http://localhost:8081/showDefaultAdvicesPage");
        ...
        if(isset($_GET['research']) || isset($_GET['filter']) || isset($_GET['sort'])){
            ...
            $dataJson = file_get_contents("http://localhost:8081/showPersonalizedAdvicesPage?id=".$id."&research=".$research."&filter=".$filter."&sort=".$sort);
    ...
    <body>
        ...
        <audio id="audio" src="audios/advices.m4a"></audio>
